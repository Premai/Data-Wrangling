...
def shape_element(element):
    ...
    if element.tag == "node" or element.tag == "way" :
        # YOUR CODE HERE
        #create the dictionary with the value from element attribute.
        ...
        for k in element.attrib:
            ...
            if k in CREATED:
                ...
                node[k] = v
        #for way add node references
        try:
            for tway in element.iter('way'):
                for w in tway:
                    try:
        ...
        try:
            ...
            pass
        #Checking if prefix'ed with 'addr' and no ':' afterwards
           ...
           # print tag.attrib['k'][:5]
            ...
            if problemchars.search(tag.attrib['k']):
               # print tag.attrib['k']
                ...
                #if second level tag "k" value starts with "addr:", add to a dictionary "address"
             ...
             #if second level tag "k" value does not start with "addr:", process it same as other tag
            else:
                #print tag.attrib['k']                
